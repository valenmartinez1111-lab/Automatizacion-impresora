...
La camara de la Falcon2 Pro S es fija y ve toda la mesa de una sola foto, asi
que la deteccion se hace con un solo par de imagenes:
...
No usa marcadores: no depende del color del material, solo de que haya
cambiado algo respecto de la mesa vacia.
"""
...
MIN_RECTANGULARITY = 0.80  # contourArea / minAreaRect area; 1.0 = rectangulo perfecto
...
def detect_sheet(
    ...
    mask = compute_changed_mask(reference_bgr, current_bgr)
